...
describe FoosController do
  ...
  let(:valid_attributes) { { "bar" => "MyString" } }
  ...
  describe "GET show" do
    it "assigns the requested foo as @foo" do
      foo = Foo.create! valid_attributes
      get :show, {:id => foo.to_param, format: :json}, valid_session
  ...
  # describe "PUT update" do
    # describe "with valid params" do
      # it "updates the requested foo" do
        ...
        # expect_any_instance_of(Foo).to receive(:update).with({ "bar" => "MyString" })
        # put :update, {:id => foo.to_param, :foo => { "bar" => "MyString" }}, valid_session
      # end
