...
(function() {
  ...
  window.JST['foo/empty'] = function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("<button class='btn btn-default list'>List </button>");
  ...
  this.App.module('Foo', function(Foo, app) {
    Foo.Controller = (function() {
      ...
      Controller.prototype.empty = function() {
        ...
        return app.vent.trigger('NAVIGATE', "foos/list");
      };
...
(function() {
  ...
  this.App.module('Foo.Views', function(Views, app) {
    ...
    return Views.Foos = (function(_super) {
      __extends(Foos, _super);
      ...
      Foos.prototype.events = {
        'click .add': function() {
          return App.vent.trigger('FOO:add');
        }
      };

      Foos.prototype.itemView = Views.Foo;

      Foos.prototype.itemViewContainer = 'ul';

      Foos.prototype.template = JST['foo/foos'];
