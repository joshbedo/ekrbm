(function() {
  ...
  window.Routes = {
// edit_foo => /foos/:id/edit(.:format)
  edit_foo_path: function(_id, options) {
  return Utils.build_path(["id"], ["format"], [2,[2,[2,[2,[2,[2,[7,"/",false],[6,"foos",false]],[7,"/",false]],[3,"id",false]],[7,"/",false]],[6,"edit",false]],[1,[2,[8,".",false],[3,"format",false]],false]], arguments);
  },
// foo => /foos/:id(.:format)
  foo_path: function(_id, options) {
  return Utils.build_path(["id"], ["format"], [2,[2,[2,[2,[7,"/",false],[6,"foos",false]],[7,"/",false]],[3,"id",false]],[1,[2,[8,".",false],[3,"format",false]],false]], arguments);
  },
// foo_list_detail => /foo/list/detail(.:format)
  foo_list_detail_path: function(options) {
  return Utils.build_path([], ["format"], [2,[2,[2,[2,[2,[2,[7,"/",false],[6,"foo",false]],[7,"/",false]],[6,"list",false]],[7,"/",false]],[6,"detail",false]],[1,[2,[8,".",false],[3,"format",false]],false]], arguments);
  },
// foos => /foos(.:format)
  foos_path: function(options) {
  return Utils.build_path([], ["format"], [2,[2,[7,"/",false],[6,"foos",false]],[1,[2,[8,".",false],[3,"format",false]],false]], arguments);
  },
// foos_new => /foos/new(.:format)
  foos_new_path: function(options) {
  return Utils.build_path([], ["format"], [2,[2,[2,[2,[7,"/",false],[6,"foos",false]],[7,"/",false]],[6,"new",false]],[1,[2,[8,".",false],[3,"format",false]],false]], arguments);
  },
...
// new_foo => /foos/new(.:format)
  new_foo_path: function(options) {
  return Utils.build_path([], ["format"], [2,[2,[2,[2,[7,"/",false],[6,"foos",false]],[7,"/",false]],[6,"new",false]],[1,[2,[8,".",false],[3,"format",false]],false]], arguments);
  },
...
(function() {
  ...
  window.JST['foo/edit'] = function(context) {
    return (function() {
      var $c, $e, $o;
      $e = window.HAML.escape;
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("<h1>Edit Foo </h1>\n<div class='alert alert-danger' style='display:none'>There was an error saving this model.</div>\n<form role='form'>\n  <div class='form-group'>\n    <label for='bar'>Bar </label>\n    <input class='form-control' id='bar' placeholder='Bar' name='bar' value='" + ($e($c(this.foo.bar))) + "'>\n  </div>\n</form>\n<button class='btn btn-default save'>Save </button>");
...
(function() {
  ...
  window.JST['foo/empty'] = function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("<div class='jumbotron'>\n  <button class='btn btn-default list'>Enjoy Your Foos </button>\n</div>");
...
(function() {
  ...
  window.JST['foo/foo'] = function(context) {
    return (function() {
      var $c, $e, $o;
      $e = window.HAML.escape;
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("<h3>" + ($e($c(this.foo.bar))) + "</h3>");
      return $o.join("\n").replace(/\s([\w-]+)='true'/mg, ' $1').replace(/\s([\w-]+)='false'/mg, '');
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  window.JST['foo/foos'] = function(context) {
    return (function() {
      var $o;
      $o = [];
...
(function() {
  ...
  window.JST['foo/list_detail'] = function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("<div class='list'></div>\n<div class='detail'></div>");
      return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  window.JST['foo/show'] = function(context) {
    return (function() {
      var $c, $e, $o;
      $e = window.HAML.escape;
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("<h1>Show</h1>\n<div class='alert alert-danger' style='display:none'>There was an error deleting this model.</div>\n<h1>Bar: ");
      $o.push("  " + $e($c(this.foo.bar)));
      $o.push("</h1>\n<button class='btn btn-default edit'>Edit</button>\n<button class='back btn btn-default'>Back</button>\n<button class='btn btn-default delete'>Delete </button>");
      return $o.join("\n").replace(/\s([\w-]+)='true'/mg, ' $1').replace(/\s([\w-]+)='false'/mg, '').replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  this.App.module('Models', function(Models, app) {
    return Models.Foo = (function(_super) {
      ...
      Foo.prototype.url = function() {
        if (this.isNew()) {
          return "/foos.json";
        }
        return "/foos/" + (this.get('id')) + ".json";
      };
...
(function() {
  ...
  this.App.module('Collections', function(Collections, app) {
    return Collections.Foos = (function(_super) {
      __extends(Foos, _super);

      function Foos() {
        return Foos.__super__.constructor.apply(this, arguments);
      }

      Foos.prototype.model = app.Models.Foo;

      Foos.prototype.url = '/foos.json';
...
(function() {
  ...
  App.module('Routers', function(Routers, app) {
    Routers.Router = (function(_super) {
      __extends(Router, _super);

      function Router() {
        app.vent.on('NAVIGATE', (function(_this) {
          return function(path) {
            return _this.navigate(path);
          };
        })(this));
      ...
      Router.prototype.routes = {
        ...
        'foo/list/detail': function() {
          return this.fooListDetail();
        },
        'foos/:id': function(id) {
          return this.fooShow(id);
        },
        'foos/:id/edit': function(id) {
          return this.fooEdit(id);
        }
      };

      Router.prototype.fooEmpty = function() {
        return app.vent.trigger('FOO:empty');
      };

      Router.prototype.fooList = function() {
        return app.vent.trigger('FOO:list');
      };

      Router.prototype.fooShow = function(id) {
        return app.vent.trigger('FOO:show', id);
      };

      Router.prototype.fooEdit = function(id) {
        return app.vent.trigger('FOO:edit', id);
      };

      Router.prototype.fooAdd = function() {
        return app.vent.trigger('FOO:add');
      };

      Router.prototype.fooListDetail = function() {
        return app.vent.trigger('FOO:listDetail');
      };
    ...
    return this.on("start", function() {
      return app.AppRouter = new Routers.Router();
    });
  });

}).call(this);
(function() {
  this.App.module('Foo', function(Foo, app) {
    Foo.Controller = (function() {
      function Controller() {
        App.vent.on('FOO:show', (function(_this) {
          return function(id) {
            return _this.show(id);
          };
        })(this));
        App.vent.on('FOO:list', (function(_this) {
          return function() {
            return _this.list();
          };
        })(this));
        App.vent.on('FOO:edit', (function(_this) {
          return function(id) {
            return _this.edit(id);
          };
        })(this));
        App.vent.on('FOO:save', (function(_this) {
          return function(model) {
            return _this.save(model);
          };
        })(this));
        App.vent.on('FOO:empty', (function(_this) {
          return function() {
            return _this.empty();
          };
        })(this));
        App.vent.on('FOO:error', (function(_this) {
          return function() {
            return _this.error();
          };
        })(this));
        App.vent.on('FOO:add', (function(_this) {
          return function() {
            return _this.add();
          };
        })(this));
        App.vent.on('FOO:delete', (function(_this) {
          return function(model) {
            return _this["delete"](model);
          };
        })(this));
        App.vent.on('FOO:listDetail', (function(_this) {
          return function() {
            return _this._fetchAll().done(function(coll) {
              app.main.show(new App.Foo.Layouts.ListDetail({
                collection: coll,
                model: coll.first()
              }));
              return app.vent.trigger('NAVIGATE', 'foo/list/detail');
            });
          };
        })(this));
      }

      Controller.prototype._fetch = function(id) {
        var deferred;
      ...
      Controller.prototype._fetchAll = function() {
        var coll, deferred;
      ...
      Controller.prototype._save = function(model) {
        var deferred;
        deferred = $.Deferred((function(_this) {
          return function(d) {
            var promise;
      ...
      Controller.prototype._delete = function(model) {
        var deferred;
        deferred = $.Deferred((function(_this) {
          return function(d) {
            var promise;
      ...
      Controller.prototype.show = function(id) {
        return this._fetch(id).done(function(model) {
          app.main.show(new Foo.Views.Show({
            model: model
          }));
          return app.vent.trigger('NAVIGATE', "foos/" + (model.get('id')));
        });
      };

      Controller.prototype.save = function(model) {
        var promise;
        promise = this._save(model);
        promise.done(function(res) {
          App.vent.trigger('FOO:show', res.get('id'));
          return App.vent.trigger('NAVIGATE', "foos/" + (res.get('id')));
        });
        return promise.fail(function() {
          return App.vent.trigger('FOO:error');
        });
      };

      Controller.prototype["delete"] = function(model) {
        var promise;
        promise = this._delete(model);
        promise.done(function(res) {
          App.vent.trigger('FOO:list');
          return App.vent.trigger('NAVIGATE', Routes.foos_path().slice(1));
        });
        return promise.fail(function() {
          return App.vent.trigger('FOO:error');
        });
      ...
      Controller.prototype.error = function() {
        if (app.main.currentView.error) {
          return app.main.currentView.error();
        }
      };
      ...
      Controller.prototype.edit = function(id) {
        return this._fetch(id).done(function(model) {
          ...
          return app.vent.trigger('NAVIGATE', "foos/" + (model.get('id')) + "/edit");
        });
      };

      Controller.prototype.list = function(collection) {
        return this._fetchAll().done(function(coll) {
      ...
      Controller.prototype.empty = function() {
        ...
        return app.vent.trigger('NAVIGATE', "");
      };
      ...
      Controller.prototype.add = function() {
        ...
        return app.vent.trigger('NAVIGATE', Routes.new_foo_path().slice(1));
      };

      return Controller;

    })();
    return Foo.on('start', function() {
      return new Foo.Controller();
    });
  });
...
(function() {
  ...
  this.App.module('Foo.Views', function(Views, app) {
    return Views.Foo = (function(_super) {
      __extends(Foo, _super);
      ...
      Foo.prototype.template = JST['foo/foo'];

      Foo.prototype.tagName = 'li';

      Foo.prototype.events = {
        'click': function() {
          return App.vent.trigger('FOO:show', this.model.get('id'));
        }
      };
...
(function() {
  ...
  this.App.module('Foo.Views', function(Views, app) {
    return Views.Edit = (function(_super) {
      ...
      Edit.prototype.template = JST['foo/edit'];
      ...
      Edit.prototype.error = function() {
        return this.ui.error.show();
      };

      Edit.prototype.events = {
        'click button.save': function() {
          this.model.set('bar', this.ui.bar.val());
          return app.vent.trigger('FOO:save', this.model);
        }
      };
...
(function() {
  ...
  this.App.module('Foo.Views', function(Views, app) {
    return Views.Empty = (function(_super) {
      ...
      Empty.prototype.template = JST['foo/empty'];

      Empty.prototype.ui = {
        list: 'button.list'
      };

      Empty.prototype.events = {
...
(function() {
  ...
  this.App.module('Foo.Views', function(Views, app) {
    return Views.List = (function(_super) {
      ...
      List.prototype.itemView = Views.Foo;

      List.prototype.itemViewContainer = 'ul';

      List.prototype.template = JST['foo/foos'];
...
(function() {
  ...
  this.App.module('Foo.Layouts', function(Layouts, app) {
    return Layouts.ListDetail = (function(_super) {
      __extends(ListDetail, _super);

      function ListDetail() {
        return ListDetail.__super__.constructor.apply(this, arguments);
      }

      ListDetail.prototype.initialize = function(options) {
        this.collection = options.collection;
        return this.model = options.model;
      };

      ListDetail.prototype.template = JST['foo/list_detail'];

      ListDetail.prototype.regions = {
        list: '.list',
        detail: '.detail'
      };

      ListDetail.prototype.onRender = function() {
        this.list.show(new app.Foo.Views.List({
          collection: this.collection
        }));
        return this.detail.show(new app.Foo.Views.Show({
          model: this.model
        }));
      };
...
(function() {
  ...
  this.App.module('Foo.Views', function(Views, app) {
    return Views.Show = (function(_super) {
      ...
      Show.prototype.template = JST['foo/show'];
      ...
      Show.prototype.error = function() {
        return this.ui.error.show();
      };

      Show.prototype.events = {
        'click button.edit': function() {
          return app.vent.trigger('FOO:edit', this.model.get('id'));
        },
        'click .back': function() {
          return app.vent.trigger('FOO:list');
        },
        'click .delete': function() {
          return app.vent.trigger('FOO:delete', this.model);
        }
      };
